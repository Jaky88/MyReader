...
import com.jaky.mupdf.alert.MuPDFAlertInternal;
import com.jaky.mupdf.bean.Annotation;
import com.jaky.mupdf.bean.OutlineItem;
import com.jaky.mupdf.bean.Separation;
import com.jaky.mupdf.linkbean.LinkInfo;
import com.jaky.mupdf.resultbean.PassClickResult;
import com.jaky.mupdf.resultbean.PassClickResultChoice;
import com.jaky.mupdf.resultbean.PassClickResultSignature;
import com.jaky.mupdf.resultbean.PassClickResultText;
import com.jaky.mupdf.textbean.TextChar;
import com.jaky.mupdf.textbean.TextWord;
...
public class MuPDFCore {
     ...
     */
    static {
        System.out.println("==========Loading mupdf_java.so===========");
        ...
        try {
            ...
            if (displayPages == 1) {
                ...
                if (drawPage == numPages - 1) {
                    ...
                    if (leftBmWidth > 0) {
                        Bitmap leftBm = Bitmap.createBitmap(leftBmWidth, patchH, Bitmap.Config.ARGB_8888);
                        gotoPage(drawPage);
                    ...
                    canvas.drawColor(Color.BLACK);
                    if (rightBmWidth > 0) {
                        Bitmap rightBm = Bitmap.createBitmap(rightBmWidth, patchH, Bitmap.Config.ARGB_8888);
                        gotoPage(drawPage);
