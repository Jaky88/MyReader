...
import com.jaky.mupdf.alert.MuPDFAlert;
import com.jaky.mupdf.async.AsyncTask;
import com.jaky.mupdf.async.CallbackApplication;
import com.jaky.mupdf.async.SafeAnimatorInflater;
import com.jaky.mupdf.async.SearchTask;
import com.jaky.mupdf.async.SearchTaskResult;
import com.jaky.mupdf.bean.Hit;
import com.jaky.mupdf.bean.Separation;
import com.jaky.mupdf.ui.PDFPreviewGridActivityData;
import com.jaky.mupdf.ui.adapter.MuPDFPageAdapter;
import com.jaky.mupdf.ui.adapter.ToolbarPreviewAdapter;
import com.jaky.mupdf.ui.views.MuPDFReaderView;
import com.jaky.mupdf.ui.views.MuPDFView;
import com.jaky.mupdf.ui.views.ReaderView;
import com.jaky.mupdf.ui.views.TwoWayView;
import com.jaky.mupdf.utils.FilePicker;
import com.jaky.mupdf.utils.LibraryUtils;
...
*/
	...
	*/
	...
	private void updatePageNumView(int index) {
		...
		CallbackApplication.MuPDFCallbackClass.sendGaiView(String.format("documentView (%1$s), page (%2$s)", mDocName, pageStr));
	}
	...
	public void OnMoreButtonClick(View v) {
		...
		if (core != null) {
			...
			CallbackApplication.MuPDFCallbackClass.sendGaiView(String.format("documentThumbView (%1$s)", mDocName));
